...
class EGServiceInfo(Poll, Converter, object):
    apid = 0
    vpid = 1
    sid = 2
    onid = 3
    ...
    def getText(self):
        ...
        if self.getServiceInfoString(info, iServiceInformation.sVideoHeight) != 'N/A':
            self.stream['yres'] = self.getServiceInfoString(info, iServiceInformation.sVideoHeight) + ('i',
                                                                                                       'p',
        ...
        self.stream['vtype'] = ('MPEG2', 'MPEG4', 'MPEG1', 'MPEG4-II', 'VC1', 'VC1-SM',
                                '')[info.getInfo(iServiceInformation.sVideoType)]
        self.stream['avtype'] = ('MPEG2/', 'MPEG4/', 'MPEG1/', 'MPEG4-II/', 'VC1/',
                                 'VC1-SM/', '')[info.getInfo(iServiceInformation.sVideoType)] + self.stream['atype']
